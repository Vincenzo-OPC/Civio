...
<body class="bg-slate-50 text-slate-900 flex items-center justify-center min-h-screen p-4 sm:p-8">
    <div class="max-w-xl w-full bg-white rounded-2xl shadow-xl overflow-hidden text-center p-8 sm:p-12">
