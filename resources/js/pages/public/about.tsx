        ...
        <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-[#0a0a0a]">
            ...
            <main className="flex-1">
                ...
                <section className="relative overflow-hidden border-b border-slate-200 bg-white py-20 lg:py-32 dark:border-slate-800 dark:bg-black">
                    ...
                    <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-3xl text-center">
                            <h1 className="mb-6 font-heading text-2xl font-black tracking-tight text-slate-900 sm:text-4xl sm:text-5xl lg:text-6xl dark:text-white">
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 lg:flex-row lg:gap-20">
                            <div className="flex-1 space-y-6 text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                                <h2 className="font-heading text-2xl font-black tracking-tight text-slate-900 sm:text-4xl sm:text-5xl dark:text-white">
                                    My Story
                                </h2>
                                <p>
                            ...
                            <div className="relative w-full flex-1">
                                ...
                                <div className="relative rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6 lg:p-8 dark:border-slate-800 dark:bg-slate-900/50">
                                    <div className="flex flex-col items-center justify-center py-10 text-center">
                                        <Users className="mb-6 size-16 text-blue-600 dark:text-blue-400 dark:text-blue-500" />
                                        <h3 className="mb-4 text-xl font-black tracking-tight text-slate-900 sm:text-3xl sm:text-4xl dark:text-white">
                                            Built For You
                                        </h3>
                ...
                <section className="border-t border-slate-200 bg-white py-20 lg:py-24 dark:border-slate-800 dark:bg-[#0a0a0a]">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mb-16 text-center">
                            <h2 className="mb-4 font-heading text-2xl font-black tracking-tight text-slate-900 sm:text-4xl sm:text-5xl dark:text-white">
                                Core Values
                            </h2>
                        ...
                        <div className="grid gap-4 sm:gap-8 md:grid-cols-2 lg:grid-cols-4">
                            {values.map((val, idx) => (
                                <div
                                    key={idx}
                                    className="rounded-2xl border border-slate-200 bg-slate-50 p-4 transition-all hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5 sm:p-6 dark:border-slate-800 dark:bg-slate-900/50"
                                >
                                    <div
                ...
                <section className="py-20 lg:py-32">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mx-auto max-w-4xl rounded-3xl bg-blue-600 px-4 py-16 text-center text-white shadow-xl sm:px-6 sm:px-12 lg:px-16">
                            <h2 className="mb-6 font-heading text-2xl font-black tracking-tight sm:text-4xl sm:text-5xl">
                            ...
                            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                                ...
                                <Button
                                    size="lg"
                                    variant="outline"
                                    className="h-14 rounded-full border-blue-400 bg-transparent px-4 text-lg font-semibold text-white hover:bg-blue-700 hover:text-white sm:px-8"
                                    asChild
                                >
                                    <Link href="/guide">
