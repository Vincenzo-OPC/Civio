        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-4xl">
                ...
                <div className="grid grid-cols-1 gap-5 py-2 md:grid-cols-12">
                    {/* Left: Template List */}
                    <div className="max-h-115 space-y-2.5 overflow-y-auto pr-1 md:col-span-5">
                    ...
                    <div className="flex flex-col justify-between rounded-2xl border border-slate-200 bg-slate-50/50 p-4 sm:p-5 md:col-span-7 dark:border-slate-800 dark:bg-slate-900/40">
                        <div className="space-y-4">
                            ...
                            {/* Topics Breakdown */}
                            <div className="max-h-40 overflow-y-auto rounded-xl border border-slate-200/80 bg-white p-3.5 dark:border-slate-800 dark:bg-slate-900">
