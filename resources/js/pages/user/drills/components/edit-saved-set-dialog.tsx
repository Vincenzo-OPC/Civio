...
function EditSavedSetModalBody({
    drillSet,
    allQuestions = [],
    categories = [],
    onClose,
    ...
    const {
        ...
        contentLabel: 'Saved Practice Set',
    ...
    // Fetch questions for this drill set
    useEffect(() => {
        let cancelled = false;

        fetch(`/drills/saved-sets/${drillSet.id}/questions`, {
    ...
    return (
        <div className="flex h-full flex-col overflow-hidden">
            ...
            <ContentShieldOverlay
                ...
                resumeButtonText="Resume Managing Set"
                descriptionText="Practice set content is protected. Click the button below to resume managing your set."
            />
            ...
            {/* Content Body with Protected Content Shield Ref */}
            <div
                ref={contentRef}
                {...wrapperProps}
                    ...
                    <form onSubmit={handleSaveDetails} className="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Brief notes about the focus or topic of this set..."
