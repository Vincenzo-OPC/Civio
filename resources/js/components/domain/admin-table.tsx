...
export function AdminTable<T>({
    ...
    return (
        ...
        >
            ...
            {totalItems > 0 && (
                <div className="flex flex-col items-center justify-between gap-3 border-t border-slate-100 bg-slate-50/20 px-4 py-4 sm:flex-row sm:px-6 dark:border-slate-900/60 dark:bg-slate-900/10">
