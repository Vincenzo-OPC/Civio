...
export function DashboardSkeleton() {
    return (
        <div className="flex animate-pulse flex-col gap-5 sm:gap-6">
            {/* Hero skeleton */}
...
export function TableSkeleton({
    ...
    return (
        <div className="animate-pulse overflow-hidden rounded-xl border border-slate-100 bg-white shadow-xs dark:border-slate-900 dark:bg-slate-950">
...
export function ExamExamSkeleton() {
    return (
        <div className="mx-auto flex max-w-4xl animate-pulse flex-col gap-6 p-4 sm:p-6">
            <div className="flex items-center justify-between">
    ...
    return (
        <div className="mx-auto flex max-w-4xl animate-pulse flex-col gap-6 p-4 sm:p-6">
            ...
            <div className="flex flex-col gap-4 rounded-2xl border border-slate-100 bg-white p-8 shadow-xs dark:border-slate-800 dark:bg-slate-900">
                ...
                <Skeleton className="my-4 h-32 w-full rounded-xl" />
                <Skeleton className="h-4 w-full rounded-md" />
    ...
    return (
        <div className="flex animate-pulse flex-col gap-6">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="h-80 rounded-2xl border border-slate-100 bg-white p-6 shadow-xs md:col-span-2 dark:border-slate-800 dark:bg-slate-900">
                    <Skeleton className="h-full w-full rounded-xl" />
                </div>
